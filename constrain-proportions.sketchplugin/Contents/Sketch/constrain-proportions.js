...
function onRun(context) {
  ...
  if (selectedCount == 0) {
    ...
    if (selectedCount == 1) {
      ...
      // multiple objects selected, so we check their constrainProportions state.
      // If it's different, we constrain all of them. If it's not different, then we toggle all of them.
